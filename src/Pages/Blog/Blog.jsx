...
<h6 className=''>Storage on the Client-Side:</h6>
<ul>
    ...
    <li>*Refresh tokens should be stored in a more persistent and secure manner, such as encrypted storage, browser local storage, or secure HTTP-only cookies.</li>
                ...
                <div>
                    ...
                    <p className='ms-6'>A. SQL databases are vertically scalable, while NoSQL databases are horizontally scalable. SQL databases are table-based, while NoSQL databases are document, key-value, graph, or wide-column stores. SQL databases are better for multi-row transactions, while NoSQL is better for unstructured data like documents or JSON. </p>
                </div>
                <div>
                    <h2 className='text-lg font-bold text-red-500'>3Q. What is express js? What is Nest JS ?</h2>
                    <p className='ms-6'>A. Nest offers a ready-to-use application architecture using controllers, providers, and modules. This enables developers and teams create applications that are simple to test and maintain.  </p>
                </div>
                <div>
                    <h2 className='text-lg font-bold text-red-500'>4Q. What is MongoDB aggregate and how does it work ?</h2>
                    <p className='ms-6'>A. MongoDB's aggregate is a feature that enables data aggregation and analysis within a MongoDB database. It allows you to perform advanced operations on collections of documents using a pipeline approach. <br />
                    <h6 className=''>works:</h6>
                   <ul>
